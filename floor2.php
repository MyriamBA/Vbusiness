...
<header class="cd-main-header js-cd-main-header">
  ...
  <main class="cd-main-content">
    ...
    <?php echo $_GET['success']; ?> </div>
      ...
      <h6>You are now in the conference room, you can assist at a coference or communicate to people !</h6><br>
      <button type="button" class="btn btn-warning">Join the Conference</button>
      <button type="button" class="btn btn-warning">Start a Conversation</button></div>
