...
<header class="cd-main-header js-cd-main-header">
  ...
  <main class="cd-main-content">
    ...
    <?php echo $_GET['success']; ?> </div>
      ...
      <h6>Your are in your own work space ! You can feel comfortable at work, you can define everything here right. </h6><br>
      <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Check your ToDo List</button>
